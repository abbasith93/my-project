...
public class Tester1002Map {
	...
	private static void req1() {
		...
		productPrices1.forEach(System.out::println);
		
		// using method reference
		List<Double> productPrices2 =
				 products.map(Product::getProductPrice)	
				         .collect(Collectors.toList());
	...
	//---------------------------------------------------------------------------------------------------------
	// Get the list of months from the product manufacturing dates.
	//---------------------------------------------------------------------------------------------------------
	private static void req5() {
		...
		yearList2.forEach(year -> System.out.println(year));
	}
}
