...
public class Tester1001Filter {
	public static void main(String[] args) {
		//Req 1 : get the products having price less than 30000
		req1();
		
		//Req 2 : get the products starting with I
		//req2();
		
		//Req 3 : get the products starting with I and price greater than 50000
		//req3();
		
		//Req 4 : get the products having manufacturing date is before 2020
		//req4();
	...
	// -----------------------------------------------------------------------------------------------------------
	// Get the products starting with I and price greater than 50000
	// ---------------------------------------------------------------------------------------------------------
	private static void req3() {
		// Using Lambda
		ProductUtility.getProductList()
					  .stream()
					  .filter(product -> product.getProductName().startsWith("I") && product.getProductPrice() > 50000)
					  .forEach(System.out::println);
	...
	public static boolean checkProductNameAndPrice(Product product) {
		return product.getProductName().startsWith("I") && product.getProductPrice() > 50000;
	}
	
	
	// -----------------------------------------------------------------------------------------------------------
	// Get the products having manufacturing date is before 2020
	// ---------------------------------------------------------------------------------------------------------
